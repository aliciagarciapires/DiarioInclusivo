...
export default function CadResp() {
    ...
    const cadastrarResponsavel = async () => {
        ...
        try {
            ...
            const response = await fetch("http://172.20.10.3/DiarioInclusivo/src/app/cadResp.php", {
    ...
    const enviarCadastro = async () => {
            ...
            const urlAPI = 'http://172.20.10.3/DiarioInclusivo/src/app/cadAdm.php'; // Substitua pelo seu IP e pasta
