...
export default function CadResp() {
    ...
    const cadastrarResponsavel = async () => {
        ...
        try {
            const response = await fetch("http://10.0.0.100/DiarioInclusivo/src/app/cadResp.php", {
                method: "POST",
    ...
    const enviarCadastro = async () => {
            const urlAPI = 'http://10.0.0.100/DiarioInclusivo/src/app/cadAdm.php'; // Substitua pelo seu IP e pasta
